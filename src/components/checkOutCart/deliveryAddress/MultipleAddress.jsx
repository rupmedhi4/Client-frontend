...
export default function MultipleAddress() {
  ...
  return (
    ...
    <div className="border border-gray-400 w-3/5 mt-8 bg-blue-500 py-4 px-4 rounded-md ">
      <span className="text-lg font-bold text-white uppercase">Delivery Address</span>

      {
        confirmDelivery ? <div className="border-l-4 border-green-600 bg-green-100 p-5 rounded-md shadow-md">
          <h3 className="text-lg font-semibold text-green-700 mb-2">Delivery Address Confirmed </h3>
